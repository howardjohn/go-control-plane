...
func (m *QuicProtocolOptions) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.PacketsToReadToConnectionCountRatio != nil {
		size, err := (*wrapperspb.UInt32Value)(m.PacketsToReadToConnectionCountRatio).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.CryptoHandshakeTimeout != nil {
		size, err := (*durationpb.Duration)(m.CryptoHandshakeTimeout).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
