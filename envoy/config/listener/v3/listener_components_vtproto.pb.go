...
func (m *Filter_ConfigDiscovery) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Filter_ConfigDiscovery) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
...
func (m *FilterChain_OnDemandConfiguration) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FilterChain_OnDemandConfiguration) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FilterChain_OnDemandConfiguration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.RebuildTimeout != nil {
		size, err := (*durationpb.Duration)(m.RebuildTimeout).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *FilterChain) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.TransportSocketConnectTimeout != nil {
		size, err := (*durationpb.Duration)(m.TransportSocketConnectTimeout).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.OnDemandConfiguration != nil {
		size, err := m.OnDemandConfiguration.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *ListenerFilter_ConfigDiscovery) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *ListenerFilter_ConfigDiscovery) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.ConfigDiscovery != nil {
		if vtmsg, ok := interface{}(m.ConfigDiscovery).(interface {
			MarshalToSizedBufferVT([]byte) (int, error)
