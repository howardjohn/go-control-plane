...
func (m *RouteConfiguration) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.ClusterSpecifierPlugins) > 0 {
		for iNdEx := len(m.ClusterSpecifierPlugins) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.ClusterSpecifierPlugins[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MaxDirectResponseBodySizeBytes != nil {
		size, err := (*wrapperspb.UInt32Value)(m.MaxDirectResponseBodySizeBytes).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.Vhds != nil {
		size, err := m.Vhds.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.ValidateClusters != nil {
		size, err := (*wrapperspb.BoolValue)(m.ValidateClusters).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if len(m.VirtualHosts) > 0 {
		for iNdEx := len(m.VirtualHosts) - 1; iNdEx >= 0; iNdEx-- {
			size, err := m.VirtualHosts[iNdEx].MarshalToSizedBufferVT(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Vhds) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *Vhds) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Vhds) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
