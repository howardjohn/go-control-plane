...
func (m *PerRouteConfig_HostRewrite) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PerRouteConfig_HostRewrite) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.HostRewrite)
...
func (m *PerRouteConfig_AutoHostRewriteHeader) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *PerRouteConfig_AutoHostRewriteHeader) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
