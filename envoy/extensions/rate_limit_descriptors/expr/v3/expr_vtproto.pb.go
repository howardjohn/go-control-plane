...
func (m *Descriptor) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if vtmsg, ok := m.ExprSpecifier.(interface {
...
func (m *Descriptor_Text) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Descriptor_Text) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= len(m.Text)
	copy(dAtA[i:], m.Text)
...
func (m *Descriptor_Parsed) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Descriptor_Parsed) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Parsed != nil {
