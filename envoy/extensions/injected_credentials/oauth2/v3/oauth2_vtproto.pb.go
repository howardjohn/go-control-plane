...
func (m *OAuth2_ClientCredentials) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *OAuth2_ClientCredentials) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *OAuth2_ClientCredentials) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *OAuth2) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if vtmsg, ok := m.FlowType.(interface {
		MarshalToSizedBufferVT([]byte) (int, error)
	}); ok {
		size, err := vtmsg.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
...
func (m *OAuth2_ClientCredentials_) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *OAuth2_ClientCredentials_) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
