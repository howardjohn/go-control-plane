...
func (m *FileSystemHttpCacheConfig) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *FileSystemHttpCacheConfig) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *FileSystemHttpCacheConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.MinEvictionPeriod != nil {
		size, err := (*durationpb.Duration)(m.MinEvictionPeriod).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.MaxEvictionPeriod != nil {
		size, err := (*durationpb.Duration)(m.MaxEvictionPeriod).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.MaxCacheEntryCount != nil {
		size, err := (*wrapperspb.UInt64Value)(m.MaxCacheEntryCount).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.MaxIndividualCacheEntrySizeBytes != nil {
		size, err := (*wrapperspb.UInt64Value)(m.MaxIndividualCacheEntrySizeBytes).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.MaxCacheSizeBytes != nil {
		size, err := (*wrapperspb.UInt64Value)(m.MaxCacheSizeBytes).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
