...
func (m *SinkConfig) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if vtmsg, ok := m.ProtocolSpecifier.(interface {
	...
	if m.UseTagExtractedName != nil {
		size, err := (*wrapperspb.BoolValue)(m.UseTagExtractedName).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.EmitTagsAsAttributes != nil {
		size, err := (*wrapperspb.BoolValue)(m.EmitTagsAsAttributes).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *SinkConfig_GrpcService) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *SinkConfig_GrpcService) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
