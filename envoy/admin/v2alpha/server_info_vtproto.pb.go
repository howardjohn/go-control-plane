...
func (m *ServerInfo) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.CommandLineOptions != nil {
		size, err := m.CommandLineOptions.MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.UptimeAllEpochs != nil {
		size, err := (*durationpb.Duration)(m.UptimeAllEpochs).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.UptimeCurrentEpoch != nil {
		size, err := (*durationpb.Duration)(m.UptimeCurrentEpoch).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *CommandLineOptions) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *CommandLineOptions) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *CommandLineOptions) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
	...
	if m.ParentShutdownTime != nil {
		size, err := (*durationpb.Duration)(m.ParentShutdownTime).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.DrainTime != nil {
		size, err := (*durationpb.Duration)(m.DrainTime).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if m.FileFlushInterval != nil {
		size, err := (*durationpb.Duration)(m.FileFlushInterval).MarshalToSizedBufferVT(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
